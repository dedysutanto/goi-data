    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baptis_klerus', models.CharField(blank=True, max_length=100, null=True, verbose_name='Klerus Yang Membaptis')),
                ('baptis_parent_id', models.IntegerField(default=0)),
                ('baptis_parent', models.CharField(blank=True, max_length=100, null=True, verbose_name='Orang Tua Baptis')),
                ...
                ('is_baptis', models.BooleanField(default=False, verbose_name='Sudah Baptis')),
                ('parokia_id', models.IntegerField(default=0)),
                ('parokia', models.CharField(blank=True, max_length=100, null=True, verbose_name='Parokia')),
                ('komox_id', models.IntegerField(default=0)),
                ('komox', models.CharField(blank=True, max_length=100, null=True, verbose_name='Komox')),

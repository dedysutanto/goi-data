    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parokia', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='parokia.parokia', verbose_name='Parokia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('komox', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='parokia.komox', verbose_name='Komunitas Orthodox')),
